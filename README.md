-- Criação de uma interface GUI no Roblox Studio com persistência e Team Check
local player = game.Players.LocalPlayer
local screenGui

local function createGui()
    -- Recria o ScreenGui e os elementos do painel
    if screenGui then
        screenGui:Destroy()
    end
...
-- Garantir que a interface seja recriada ao renascer
player.CharacterAdded:Connect(function()
    wait(1) -- Pequeno atraso para garantir que o personagem tenha carregado
    createGui()
end)
