-- Criação de uma interface GUI no Roblox Studio
-- Este script deve ser colocado em StarterGui -> ScreenGui
    ...
    button.MouseButton1Click:Connect(function()
        ...
        if funcName == "ESP" then
            if states.ESP then
                -- Ativar ESP
                print("ESP ativado")
                -- Exemplo: Mostrar todos os jogadores no mapa
        ...
        elseif funcName == "Hitbox" then
            if states.Hitbox then
                ...
                -- Exemplo: Aumentar hitbox dos inimigos
                for _, p in pairs(game.Players:GetPlayers()) do
                    if p ~= player then
        ...
        elseif funcName == "Aimbot" then
            print("Aimbot " .. (states.Aimbot and "ativado" or "desativado"))
            -- A lógica do Aimbot precisaria de mais detalhes, como
            -- identificar o jogador mais próximo e ajustar a câmera.
        end
    end)
end-- Criação de uma interface GUI no Roblox Studio
-- Este script deve ser colocado em StarterGui -> ScreenGui
